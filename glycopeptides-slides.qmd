---
title: "Glycopeptides & Lipoglycopeptides"
subtitle: "Vancomycin · Teicoplanin · Telavancin · Dalbavancin · Oritavancin"
...
format:
  revealjs:
    ...
    slide-number: true
    transition: fade
    logo: glycopeptides-images/unipd_seal_white.svg
    width: 1280
    height: 800
---
...
::: {.notes}
This lecture is aimed at postgraduate ID specialists. Heavy on PK/PD, resistance mechanisms, and stewardship judgement; lighter on basic spectrum review which you should already know. 1.5 hour slot with 80 slides — pace ~1 minute per slide with extended discussion at evidence-heavy slides (AUC monitoring, VISA mechanisms, lipoglycopeptide clinical trials).
:::

# Class overview

## Five agents, one core mechanism {.smaller}
...
::: aside
Murray, Arias, Nannini, Mandell 9th ed., 2025
:::
...
- All five bind the **D-Ala-D-Ala terminus** of nascent peptidoglycan precursors
- Blocks **transglycosylation** and **transpeptidation** → cell wall synthesis halts in dividing organisms
- Bactericidal against most gram-positive cocci; **no gram-negative activity** (outer membrane impermeable)
- Pharmacodynamic index for efficacy: **AUC/MIC** (not C~max~ or trough)

::: aside
Reynolds, *Eur J Clin Microbiol Infect Dis*, 1989
:::

::: {.notes}
Important pedagogical point: glycopeptides are bactericidal but slowly so compared to beta-lactams. The AUC/MIC index reflects this — duration of exposure matters more than peak. The lipoglycopeptides modify this with concentration-dependent activity from their membrane component, which is why they tolerate single-dose regimens.
:::

## How glycopeptides bind D-Ala-D-Ala {.smaller}
...
::: aside
Walsh, *Science*, 1993; Williams & Bardsley, *Angew Chem Int Ed*, 1999
:::

::: {.notes}
The 1000-fold affinity loss from a single hydrogen bond substitution is one of the most elegant molecular explanations in microbiology. Understanding this helps with the rest: why VanB enterococci are still teicoplanin-susceptible (no induction), why oritavancin's secondary binding site rescues activity against VanA, and why telavancin's membrane mechanism partially compensates for VISA cell-wall thickening.
:::

## Why lipoglycopeptides act differently

The added **lipid tail** in telavancin, dalbavancin, and oritavancin produces two additional effects beyond D-Ala-D-Ala binding:

- **Membrane anchoring** → depolarisation, increased permeability (most pronounced with telavancin and oritavancin)
- **Dimerisation enhancement** → higher avidity for target

Net result: faster bactericidal kinetics, activity against some VISA/hVISA strains, and (for oritavancin) activity against VanA enterococci.

::: aside
Higgins et al., *Antimicrob Agents Chemother*, 2005; Lunde et al., *Antimicrob Agents Chemother*, 2009
:::
...
<!-- IMAGE NEEDED: Vancomycin chemical structure showing the heptapeptide core and the D-Ala-D-Ala binding pocket -->
...
## Vancomycin tissue penetration {.smaller}
...
::: aside
Weiner et al., *Infect Control Hosp Epidemiol*, 2016; ECDC EARS-Net 2020; Contreras et al., *Open Forum Infect Dis*, 2021
:::
...
## VRE mechanisms — the *van* gene clusters {.smaller}
...
::: aside
Ahmed & Baptiste, *Microb Drug Resist*, 2018; Guffey & Loll, *Microorganisms*, 2021
:::
...
# Vancomycin resistance — staphylococci

## hVISA, VISA, VRSA — the definitions {.smaller}
...
::: aside
Shariati et al., *Sci Rep*, 2020; Howden et al., *PloS Pathog*, 2011; CDC, 2023
:::
...
- Selection under vancomycin exposure → mutations in **two-component regulatory systems**: GraSR, WalKR/YycFG, VraTSR
- These regulate cell-wall biosynthesis genes → **thickened cell wall with abundant free D-Ala-D-Ala residues**
- Free D-Ala-D-Ala in the cell wall periphery "traps" vancomycin before it reaches active synthesis sites at the membrane
- Effect: **functional resistance** despite no change in target affinity

::: aside
Hiramatsu, *Lancet Infect Dis*, 2001; Howden et al., *Antimicrob Agents Chemother*, 2010
:::

::: {.notes}
Conceptually elegant — the bug doesn't change its target, it builds extra target to soak up the drug. Same therapeutic implication: more vancomycin is unlikely to overcome it, so switch agents. Linezolid, daptomycin (with caveats for cross-resistance), ceftaroline, or one of the lipoglycopeptides are alternatives.
:::

## VRSA — the rare event {.smaller}
...
::: aside
CDC AR Threats, 2023; Sievert et al., 2008
:::

::: {.notes}
VRSA is rare enough that you may never see a case, but you should recognise the risk factor — chronic wounds with concomitant MRSA and VRE colonisation in patients on prolonged vancomycin. The clinical implication is straightforward: treatment options exist but require active resistance testing.
:::

## MIC "creep" and clinical failure {.smaller}
...
::: aside
Sakoulas et al., *Clin Infect Dis*, 2004; van Hal et al., *Clin Infect Dis*, 2012; Liu et al., *Clin Infect Dis*, 2011
:::
...
- Therapeutic window for serious MRSA: **AUC 400–600**

::: aside
Moise-Broder et al., *Clin Pharmacokinet*, 2004; Lodise et al., *Clin Infect Dis*, 2020
:::
...
- Old paradigm: target trough 15–20 mg/L for serious MRSA
- Surrogate logic: troughs at this level *should* produce AUC/MIC ≥ 400
- **Problem**: the trough-to-AUC relationship is highly variable
- Patients achieving "therapeutic" troughs of 15–20 often have AUC > 600 → AKI risk
- Bayesian AUC monitoring with two timed levels (or even one) outperforms trough-based dosing in achieving target exposure

::: aside
Lodise et al., *Clin Infect Dis*, 2020; Rybak et al., *Am J Health-Syst Pharm*, 2020
:::

::: {.notes}
This is the single most important practical update from the last few years. If you're still managing serious MRSA infections with trough-only monitoring, you're behind the times. Bayesian software like InsightRx, DoseMe, or PrecisePK is increasingly available; the alternative is two-level first-order equations. The evidence base for AUC monitoring is still mostly retrospective — large prospective trials are ongoing — but the pharmacokinetic logic is sound.
:::

## 2020 ASHP/IDSA/PIDS/SIDP guidelines — key points {.smaller}
...
::: aside
Rybak et al., *Am J Health-Syst Pharm*, 2020 (Revised consensus guideline)
:::
...
## Vancomycin in special populations {.smaller}
...
::: aside
Rybak et al., 2020 consensus guideline
:::
...
## Vancomycin dosing summary {.smaller}
...
::: aside
ISPD Peritonitis Guidelines, 2016
:::
...
::: {.notes}
Common exam question and common clinical scenario. Key teaching point: this is not an allergy, it's a pseudoallergic reaction. Patients can usually continue vancomycin with slower infusion and antihistamine premedication. True IgE-mediated anaphylaxis to vancomycin is exceedingly rare.
:::
...
- Concomitant nephrotoxins, especially **piperacillin-tazobactam**
- Duration >14 days
...
::: aside
Marissen et al., *J Antimicrob Chemother*, 2020
:::
...
- Avoid concomitant nephrotoxins (especially **piperacillin-tazobactam** — use cefepime or carbapenem if combination needed)
...
::: aside
Rybak et al., 2020; Luther et al., *Crit Care Med*, 2018
:::
...
::: aside
Liu et al., *Clin Infect Dis*, 2011; Kalil et al., *Clin Infect Dis*, 2016
:::
...
## Persistent MRSA bacteraemia — alternatives {.smaller}
...
::: aside
Munita et al., *Clin Infect Dis*, 2015; Contreras et al., *OFID*, 2021
:::
...
- **Oral vancomycin 125 mg q6h × 10 days** — first-line for non-fulminant initial episode (IDSA/SHEA 2021)
...
::: aside
McDonald et al., *Clin Infect Dis*, 2021
:::
...
## Teicoplanin TDM — the critical detail {.smaller}
...
::: aside
Pea et al., *J Antimicrob Chemother*, 2003
:::

::: {.notes}
This is THE teaching point on teicoplanin: failing to load is the most common reason for treatment failure. Trough <20 mg/L on day 4 is associated with worse outcomes in *S. aureus* infection. The loading regimen scales with infection severity. Many older European practice patterns under-dose teicoplanin because they predate the modern target-trough literature.
:::
...
::: aside
Svetitsky et al., *Antimicrob Agents Chemother*, 2009 (meta-analysis)
:::

::: {.notes}
Russ — given the Italian audience, teicoplanin is very much in routine use here. The 2009 Svetitsky meta-analysis is the standard reference on nephrotoxicity comparison — about a 40% lower relative risk of nephrotoxicity with teicoplanin vs vancomycin. Efficacy comparable when adequately loaded and dosed.
:::

# Lipoglycopeptides — the three newcomers

## Three drugs, three personalities {.smaller}
...
::: aside
Drug prescribing information, FDA 2009–2014
:::

::: {.notes}
This single comparison table captures most of what's clinically distinguishing about the three. The half-life differences and the coag-assay issues are what most affect practical decision-making.
:::
...
::: aside
Higgins et al., *Antimicrob Agents Chemother*, 2005
:::

::: {.notes}
The dual mechanism is the marketing pitch. Clinically, the lower MIC and faster bactericidal kinetics matter most for high-inoculum infections like endocarditis (where telavancin was never developed as a primary indication, oddly).
:::
...
::: aside
Stryjewski et al., *Clin Infect Dis*, 2008; Rubinstein et al., *Clin Infect Dis*, 2011
:::

::: {.notes}
The HAP/VAP indication came with the caveat — "when alternative treatments are not suitable" — because of the mortality signal in renal-impaired patients. This is a typical FDA pattern when efficacy is there but safety is wobbly.
:::
...
::: aside
Boucher et al., *N Engl J Med*, 2014
:::

::: {.notes}
The half-life is the headline. Two-dose or single-dose treatment that delivers a full course on day 1 — the clinical operational implications are huge for outpatient management of skin infections.
:::

## Dalbavancin — clinical trial backbone {.smaller}
...
- **DOTS** (Rappo 2019): open-label single-arm cohort for diabetic foot osteomyelitis — promising
- **Vertebral osteomyelitis** (open-label cohort): efficacious; growing real-world experience

::: aside
Boucher et al., *N Engl J Med*, 2014; Dunne et al., *Clin Infect Dis*, 2016; Rappo et al., *J Antimicrob Chemother*, 2019
:::

::: {.notes}
DISCOVER trials established ABSSSI indication. The single-dose 1500 mg regimen (Dunne 2016) is increasingly preferred for operational simplicity. Off-label use in osteomyelitis and infective endocarditis is growing fast — particularly in IV drug users and other populations where adherence to prolonged IV therapy is challenging.
:::
...
- Multiple RCTs in progress (e.g., DOTS-2 for endocarditis)

::: aside
Bork et al., *OFID*, 2019; Wunsch et al., *Drugs Real World Outcomes*, 2019
:::

::: {.notes}
This is one of the most discussed off-label applications of dalbavancin. The clinical reasoning is straightforward — these patients are at high risk for line infections, often leave AMA, and can't reliably complete a 4-6 week IV course. A single dose of dalbavancin delivers measurable advantages. The evidence base is observational but growing rapidly; prospective RCTs are needed to confirm non-inferiority to standard care.
:::

## Dalbavancin — practical use {.smaller}
...
::: aside
Corey et al., *Clin Infect Dis*, 2015; Van Hise et al., *Drugs Real World Outcomes*, 2020
:::

::: {.notes}
The 1-hour Kimyrsa formulation is increasingly preferred operationally over the 3-hour Orbactiv. Same drug, different vehicle. Off-label use for VRE bacteraemia is increasingly reported and is the most distinctive niche for oritavancin given the lack of other long-acting options for VRE.
:::
...
# Stewardship and practical decision-making

## When to use lipoglycopeptides {.smaller}
...
## Pharmacoeconomics — when does cost make sense? {.smaller}
...
## Case 1 — MRSA bacteraemia with rising creatinine {.smaller}
...
## Case 3 — VanA VRE bacteraemia {.smaller}
...
## Five key teaching points {.smaller}
...
::: {.notes}
If your students walk away knowing these five things, they'll handle 95% of clinical situations correctly. The rest is detail.
:::
...
::: {.notes}
These are intentionally open. Use them to start discussion or send students away to research local data. Local prevalence and lab capabilities really do shape practice in ways that the textbook doesn't capture.
:::
...
::: {.notes}
The companion webpage QMD has the complete reference list with full citations rendered through the diagnostic-microbiology-and-infectious-disease.csl style.
:::
...
:::
cin cannot bind effectively, but oritavancin can still inhibit transpeptidation through its alternative binding site. This is genuinely useful clinically — oritavancin is one of the few glycopeptide-class drugs that works against VRE.
:::
...
::: {.notes}
The cost-effectiveness math hinges entirely on the local ward bed cost and the realistic counterfactual. In US settings with admission costs of $2-5k/day, a single 1500 mg dalbavancin dose easily pays for itself if it prevents 2 admission days. In settings with cheaper beds and well-developed OPAT, the math is harder.
:::
