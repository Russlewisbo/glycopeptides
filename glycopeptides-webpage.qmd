...
![](glycopeptides-images/dmmunipd_logo.jpeg){width=200px fig-align="left"}

::: {.callout-note}
## About this lecture
This companion document accompanies the slide deck and expands on every section presented during the lecture. Content adapted from the chapter by Murray, Arias, and Nannini in *Mandell, Douglas, and Bennett's Principles and Practice of Infectious Diseases*, with selected updates from the recent literature.
:::
...
: Routes, recommended dosages, and infusion characteristics of the glycopeptides and lipoglycopeptides {#tbl-dosing}
...
: Comparative summary of glycopeptides and lipoglycopeptides {#tbl-comparison}
...
::: {.callout-note}
## Dedication
This chapter is dedicated to the memory of Dr. Barbara Murray (1947–2023), trailblazer in infectious diseases, fearless leader, exceptional scientist, and everlasting mentor.
:::
